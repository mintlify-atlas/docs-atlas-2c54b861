---
title: "Master Data API Endpoints for GSM Operations Service"
sidebarTitle: "Master Data"
description: "Access global parameters, herb product catalogs, employee and supplier directories, product categories, and SKU definitions from the GSM Operations API."
---
...
<ResponseField name="data" type="array">
  ...
  <Expandable title="GlobalParameterDTO (each item)">
    ...
    <ResponseField name="paramAttributes" type="array">
      ...
      <Expandable title="ParamAttribute (each item)">
        <ResponseField name="idParamAttribute" type="integer" required>
        ...
        <ResponseField name="globalParameter" type="object | null">
