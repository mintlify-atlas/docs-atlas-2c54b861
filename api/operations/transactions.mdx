...
description: "Create, update, and search GSM Operations transactions with attributes, products, states, and typed detail lines across the full transaction lifecycle."
---
