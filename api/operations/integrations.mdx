...
description: "Invoke pre-configured API rules through the GSM Operations exec-api engine to proxy calls to external endpoints with custom headers and body."
---
