...
description: "Reference for GSMApplication — per-profile menu trees, multimedia resources, user password management, and tenant-scoped API rule configuration."
---
