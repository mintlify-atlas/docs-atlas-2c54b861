...
sidebarTitle: "Home"
description: "GSM Application is a full-stack, multi-tenant SaaS platform for agricultural operations management, featuring a React SPA, API gateway, and three independent .NET microservices."
---
