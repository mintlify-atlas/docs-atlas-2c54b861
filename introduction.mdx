---
title: "GSM Application: Multi-Tenant Agricultural Operations Platform"
sidebarTitle: "Introduction"
description: "GSM Application is a multi-tenant SaaS platform for agricultural operations, built on a microservices architecture with per-tenant database isolation and a React frontend."
---
...
<CardGroup cols={2}>
  <Card title="Database-Per-Tenant Isolation" icon="database">
  ...
  <Card title="YARP API Gateway" icon="shield-halved">
  ...
  <Card title="Agricultural Operations Domain" icon="tractor">
  ...
  <Card title="Internationalised React SPA" icon="globe">
