---
title: "Per-Tenant CSS Theming with JsonStyles in GSM"
sidebarTitle: "Tenant Theming"
description: "How GSM Application loads, validates, and applies per-company CSS variable themes stored as JSON in the Tenants registry table."
---
